...
interface TopSectorsListProps {
  topSectorsLoading: boolean;
  mapDataLoading: boolean;
}

const TopSectorsList: React.FC<TopSectorsListProps> = (props) => {
  const { topSectorsLoading, mapDataLoading } = props;
    ...
    return (
      <div className="m-5 w-80">
        <div className="alert">
          ...
          <span>
            Select a year and sector to display top sectors for each hovered
            county
          </span>
        </div>
      </div>
  ...
  if (topSectorsLoading || mapDataLoading) {
    return (
      <div className="m-5 w-80">
    ...
    return (
      <div className="m-5 w-80">
        ...
        <div className="alert alert-warning">
          ...
          <span>
            No Top Sectors Data Avaliable for {hoveredCounty},{" "}
            {hoveredStateCode}
          </span>
        </div>
      </div>
